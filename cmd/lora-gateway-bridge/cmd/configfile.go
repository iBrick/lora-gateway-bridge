...
marshaler="{{ .Integration.Marshaler }}"
  ...
  #
  # When set to true, instead of re-trying to connect, the Gateway Bridge
...
[metrics]
  ...
  #
  # These metrics expose information about the state of the Gateway Bridge
...
# Gateway meta-data.
#
# The meta-data will be added to every stats message sent by the Gateway Bridge.
[meta_data]
  ...
  # Split delimiter.
  #
  # When the output of a command returns multiple lines, Gateway Bridge
...
var configCmd = &cobra.Command{
	Use:   "configfile",
	Short: "Print LoRa Gateway Bridge configuration file",
